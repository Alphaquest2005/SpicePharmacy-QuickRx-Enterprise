...
namespace QuickBooks
{
    public class ItemInventoryViewModel
    {
        ...
        public IEnumerable<ItemInventoryRet> WalkItemInventoryQueryRs(IMsgSetResponse responseMsgSet)
        {
        ...
        private static void RemoveAllIDbInventoryItems(QBPOSEntities db)
        {
            ...
            {
                db.InventoryItems.DeleteObject(eitm);
            }
        }
      public  QuickBooks.TrackableCollection<ItemInventoryRet> WalkItemInventoryRet(IItemInventoryRetList ItemInventoryRetList)
        {
            ...
            for (int i = 0; i < ItemInventoryRetList.Count; i++)
            {
                ...
                //Get value of price
                if (positm.Price1 != null)
                {
                    itm.Price1 = (Decimal)positm.Price1.GetValue();
                }

                //Get value of TaxCode
                if (positm.TaxCode != null)
                {
                    itm.TaxCode = (string)positm.TaxCode.GetValue();
                }
