...
[assembly: DbMappingViewCacheTypeAttribute(
    ...
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets7f4b5c0fc25ac7ae6d8bcb645e71da3369491720298ee73ff5ea575c24e43a05))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets7f4b5c0fc25ac7ae6d8bcb645e71da3369491720298ee73ff5ea575c24e43a05 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "7f4b5c0fc25ac7ae6d8bcb645e71da3369491720298ee73ff5ea575c24e43a05"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "RMSEntitiesStoreContainer.SearchView")
            {
                return GetView30();
            }

            if (extentName == "RMSModel.SearchViews")
            {
                return GetView31();
            }

            if (extentName == "RMSEntitiesStoreContainer.DoctorsView")
            {
                return GetView32();
            }

            if (extentName == "RMSModel.DoctorsViews")
            {
                return GetView33();
            }

            if (extentName == "RMSEntitiesStoreContainer.PatientView")
            {
                return GetView34();
            }

            if (extentName == "RMSModel.PatientViews")
            {
                return GetView35();
            }
    ...
    FROM (
        SELECT 
            ...
            T.TransactionNumber AS TransactionBase_TransactionNumber, 
            True AS _from0
    ...
    FROM (
        SELECT 
            ...
            T.ItemId AS TransactionEntryBase_ItemId, 
    ...
    SELECT VALUE -- Constructing TransactionEntryBase_PrescriptionEntry
        [RMSEntities.Store.TransactionEntryBase_PrescriptionEntry](T1.[TransactionEntryBase_PrescriptionEntry.Dosage], T1.[TransactionEntryBase_PrescriptionEntry.ExpiryDate], T1.[TransactionEntryBase_PrescriptionEntry.TransactionEntryId], T1.[TransactionEntryBase_PrescriptionEntry.Repeat], T1.[TransactionEntryBase_PrescriptionEntry.RepeatCount])
    FROM (
        SELECT 
            ...
            TREAT(T AS [RMSEntities.PrescriptionEntry]).RepeatCount AS [TransactionEntryBase_PrescriptionEntry.RepeatCount], 
            True AS _from0
        FROM RMSModel.TransactionEntryBase AS T
    ...
    SELECT VALUE -- Constructing Stores
        [RMSEntities.Store.Stores](T1.Stores_StoreId, T1.Stores_StoreCode, T1.Stores_StoreAddress, T1.Stores_CompanyId, T1.Stores_TransactionSeed, T1.Stores_EntryTimeStamp)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing TransactionBase
        CASE
            WHEN (NOT(T4._from1) AND NOT(T4._from2)) THEN [RMSEntities.TransactionBase](T4.TransactionBase_StationId, T4.TransactionBase_BatchId, T4.TransactionBase_CloseBatchId, T4.TransactionBase_Time, T4.TransactionBase_CustomerId, T4.TransactionBase_CashierId, T4.TransactionBase_Comment, T4.TransactionBase_ReferenceNumber, T4.TransactionBase_StoreCode, T4.TransactionBase_TransactionId, T4.TransactionBase_OpenClose, T4.TransactionBase_PharmacistId, T4.TransactionBase_Status, T4.TransactionBase_EntryTimeStamp, T4.TransactionBase_TransactionNumber)
            WHEN T4._from1 THEN [RMSEntities.Prescription](T4.TransactionBase_StationId, T4.TransactionBase_BatchId, T4.TransactionBase_CloseBatchId, T4.TransactionBase_Time, T4.TransactionBase_CustomerId, T4.TransactionBase_CashierId, T4.TransactionBase_Comment, T4.TransactionBase_ReferenceNumber, T4.TransactionBase_StoreCode, T4.TransactionBase_TransactionId, T4.TransactionBase_OpenClose, T4.TransactionBase_PharmacistId, T4.TransactionBase_Status, T4.TransactionBase_EntryTimeStamp, T4.TransactionBase_TransactionNumber, T4.Prescription_DoctorId, T4.Prescription_PatientId)
    ...
    FROM (
        ...
        FROM  (
            ...
            SELECT 
                ...
                T.RepeatCount AS PrescriptionEntry_RepeatCount, 
                True AS _from1
    ...
    FROM (
        ...
        private static DbMappingView GetView24()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing Stores
        [RMSEntities.Store](T1.Store_StoreId, T1.Store_StoreCode, T1.Store_StoreAddress, T1.Store_CompanyId, T1.Store_TransactionSeed, T1.Store_EntryTimeStamp)
    FROM (
        SELECT 
    ...
    FROM (
        SELECT 
            ...
            T.TotalSales AS TransactionsView_TotalSales, 
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for RMSEntitiesStoreContainer.SearchView.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView30()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing SearchView
        [RMSEntities.Store.SearchView](T1.SearchView_Time, T1.SearchView_TransactionId, T1.SearchView_ItemId, T1.SearchView_ItemInfo, T1.SearchView_PatientId, T1.SearchView_PatientInfo, T1.SearchView_DoctorId, T1.SearchView_DoctorInfo, T1.SearchView_SearchInfo)
    FROM (
        SELECT 
            T.Time AS SearchView_Time, 
            T.TransactionId AS SearchView_TransactionId, 
            T.ItemId AS SearchView_ItemId, 
            T.ItemInfo AS SearchView_ItemInfo, 
            T.PatientId AS SearchView_PatientId, 
            T.PatientInfo AS SearchView_PatientInfo, 
            T.DoctorId AS SearchView_DoctorId, 
            T.DoctorInfo AS SearchView_DoctorInfo, 
            T.SearchInfo AS SearchView_SearchInfo, 
            True AS _from0
        FROM RMSModel.SearchViews AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for RMSModel.SearchViews.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView31()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing SearchViews
        [RMSEntities.SearchView](T1.SearchView_Time, T1.SearchView_TransactionId, T1.SearchView_ItemId, T1.SearchView_ItemInfo, T1.SearchView_PatientId, T1.SearchView_PatientInfo, T1.SearchView_DoctorId, T1.SearchView_DoctorInfo, T1.SearchView_SearchInfo)
    FROM (
        SELECT 
            T.Time AS SearchView_Time, 
            T.TransactionId AS SearchView_TransactionId, 
            ...
            T.SearchInfo AS SearchView_SearchInfo, 
            True AS _from0
        FROM RMSEntitiesStoreContainer.SearchView AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for RMSEntitiesStoreContainer.DoctorsView.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView32()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing DoctorsView
        [RMSEntities.Store.DoctorsView](T1.DoctorsView_Name, T1.DoctorsView_Code, T1.DoctorsView_DoctorId)
    FROM (
        SELECT 
            T.Name AS DoctorsView_Name, 
            T.Code AS DoctorsView_Code, 
            T.DoctorId AS DoctorsView_DoctorId, 
            True AS _from0
        FROM RMSModel.DoctorsViews AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for RMSModel.DoctorsViews.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView33()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing DoctorsViews
        [RMSEntities.DoctorsView](T1.DoctorsView_Name, T1.DoctorsView_Code, T1.DoctorsView_DoctorId)
    FROM (
        SELECT 
            T.Name AS DoctorsView_Name, 
            T.Code AS DoctorsView_Code, 
            T.DoctorId AS DoctorsView_DoctorId, 
            True AS _from0
        FROM RMSEntitiesStoreContainer.DoctorsView AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for RMSEntitiesStoreContainer.PatientView.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView34()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing PatientView
        [RMSEntities.Store.PatientView](T1.PatientView_Name, T1.PatientView_PhoneNumber, T1.PatientView_Address, T1.PatientView_PatientId)
    FROM (
        SELECT 
            T.Name AS PatientView_Name, 
            T.PhoneNumber AS PatientView_PhoneNumber, 
            T.Address AS PatientView_Address, 
            T.PatientId AS PatientView_PatientId, 
            True AS _from0
        FROM RMSModel.PatientViews AS T
    ) AS T1");
        }

        /// <summary>
        /// Gets the view for RMSModel.PatientViews.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView35()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing PatientViews
        [RMSEntities.PatientView](T1.PatientView_Name, T1.PatientView_PhoneNumber, T1.PatientView_Address, T1.PatientView_PatientId)
    FROM (
        SELECT 
            T.Name AS PatientView_Name, 
            T.PhoneNumber AS PatientView_PhoneNumber, 
            ...
            T.PatientId AS PatientView_PatientId, 
            True AS _from0
        FROM RMSEntitiesStoreContainer.PatientView AS T
    ) AS T1");
        }
    ...
    SELECT VALUE -- Constructing ItemDosage
        [RMSEntities.Store.ItemDosage](T1.ItemDosage_ItemId, T1.ItemDosage_Dosage, T1.ItemDosage_Count)
    FROM (
        SELECT 
    ...
    SELECT VALUE -- Constructing ItemDosages
        [RMSEntities.ItemDosage](T1.ItemDosage_ItemId, T1.ItemDosage_Dosage, T1.ItemDosage_Count)
    FROM (
        SELECT 
            T.ItemId AS ItemDosage_ItemId, 
            T.Dosage AS ItemDosage_Dosage, 
